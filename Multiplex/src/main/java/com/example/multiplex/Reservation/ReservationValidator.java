...
import com.example.multiplex.Config.ReservationProperties;
import com.example.multiplex.Reservation.DTO.ReservationDataDto;
import com.example.multiplex.Reservation.DTO.SeatDTO;
import com.example.multiplex.Reservation.Exception.ValidationException;
...
public class ReservationValidator {
    ...
    boolean checkIfSeatsAreAvailable(ReservationDataDto reservationDataDto){
         ...
         Set<Long> allTakenSeatsId = seatRepository.getSeatByTakenTrue().stream().map(Seat::getId).collect(Collectors.toSet());
